...
def build_model():
    ...
    # create wide column group
    wide_columns = [
        gender, workclass, education, occupation, relationship, native_country, age,
        layers.crossed_column([education, occupation], hash_bucket_size=int(1e4)),
        layers.crossed_column([native_country, occupation], hash_bucket_size=int(1e4)),
        layers.crossed_column([age, education, occupation], hash_bucket_size=int(1e6))]
    ...
    # create the model
    return estimators.DNNLinearCombinedClassifier(
